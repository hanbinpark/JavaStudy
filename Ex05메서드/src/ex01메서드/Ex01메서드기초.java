...
public class Ex01메서드기초 {
	...
	// 4) 메서드명(호출명)
	// + 호출명 옆에는 반드시 소괄호()
	// + 모든 메서드들은 소괄호를 가지고이 있다! main(),syso()
	...
	public static int sum(int a, int b) {
		...
		int result = a + b;
		return result;
		// return 키워드는 호출한 곳으로 결과값을 보내준다
		// 언제 작성?
		// : 리턴타입 자리에 데이터타입이 명시되어있으면 반드시 따라온다!
	...
	public static void main(String[] args) {
		...
		int a = 3;
		int b = 5;
		sum(a, b); 		// 값을 더해주는 기능, 출력 X
		System.out.println(sum(a, b)); // 값을 확인하고 싶으면 출력문으로 작성해야 함 
